...
##   .. )
##  - attr(*, "problems")=<pointer: 0x00000239299f8540>
```
...
county_drive_time_plot <- ggplot(
  ...
  geom_point(alpha = 0.7) + scale_size_continuous(range = c(2, 8), guide = "none") +
  labs(
