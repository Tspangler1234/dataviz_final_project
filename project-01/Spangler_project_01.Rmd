...
```{r visualization-2, fig.alt="Scatterplot showing the relationship between danceability and valence for Billboard summer hits. Each point represents one song, and the dashed trend line shows a positive relationship."}
...
```{r visualization-3, fig.alt="Boxplots comparing danceability scores for Billboard summer hits by decade. The chart shows that more recent decades generally have higher median danceability scores than earlier decades."}
billboard_hits %>%
  mutate(
    decade = factor(
      paste0(floor(year / 10) * 10, "s"),
