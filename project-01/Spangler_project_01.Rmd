...
```{r project1-bad-scatter, message=FALSE, warning=FALSE, fig.alt="A poorly designed scatterplot showing danceability and valence for Billboard summer hits. Points are large and opaque, colors are harder to interpret, and the chart does not include a trend line."}
...
```{r project1-redesigned-scatter, message=FALSE, warning=FALSE, fig.alt="Redesigned scatterplot showing the relationship between danceability and valence for Billboard summer hits. Transparent points reduce overlap, a colorblind-friendly palette separates decades, and a dashed trend line shows the overall relationship."}
ggplot(billboard_hits, aes(x = danceability, y = valence, color = decade)) +
